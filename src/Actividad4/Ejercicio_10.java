...
public class Ejercicio_10 {
    public static void main(String[] args) {
        ...
        carros.add(new Car("Ferrari", 50000));
        carros.add(new Car("Audi", 40000));
        carros.add(new Car("Mercedes-Benz", 60000));
        carros.add(new Car("Rolls Royce", 70000));
        int maxPrice = 0;
        ...
        System.out.println("La marca de coches más costoso es: " + mostExpensiveBrand);
    }
}
class Car {
